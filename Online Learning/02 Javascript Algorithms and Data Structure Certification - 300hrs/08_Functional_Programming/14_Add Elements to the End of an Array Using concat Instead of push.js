...
into a new one without mutating the original arrays. Compare concat to the 
push method:  push adds an item to the end of the same array it is called on, 
which mutates that array. 
...
/* 
arr would have a modified value of [1, 2, 3, [4, 5, 6]], which is not the 
